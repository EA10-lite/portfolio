...
const Footer = () => {
    return (
        <footer className="footer bg-white rounded-t-[16x] md:rounded-t-[64px] lg:rounded-t-[132px] mt-[120px]">
            <div className="container px-[16px] md:px-[24px] mx-auto">
                <div className="top-footer-content py-[32px] md:py-[64px]">
                    ...
                    <div className="flex items-center gap-4 justify-center">
                        <a href="mailto:emanuelanyigor@gmail.com" className="flex items-center justify-center gap-2 rounded-[133.333px] border border-[2px] border-dark bg-black text-white text-xs px-[12px] py-[8px] w-[119px] shadow">
                            <MdOutlineMailOutline className="text-[18px]" />
                            <span> Email Me </span>
                        </a>
                        <a href="https://wa.me/+2347061326122" className="rounded-[133.333px] border border-[2px] border-primary text-xs py-[8px] px-[12px] w-[119px] flex items-center justify-center gap-2 shadow"> 
                            <span>Whatsapp </span>
